...
const HYMNS = [
  // GRACE & SALVATION
  { id:'amazing-grace', title:'Amazing Grace', author:'John Newton (1779)', category:'Grace & Salvation', key:'G',
    verses:[
  ...
  { id:'just-as-i-am', title:'Just As I Am', author:'Charlotte Elliott (1835)', category:'Grace & Salvation', key:'Eb',
    verses:[
  ...
  { id:'rock-of-ages', title:'Rock of Ages', author:'Augustus M. Toplady (1776)', category:'Grace & Salvation', key:'Bb',
    verses:[
  ...
  { id:'grace-greater', title:'Grace Greater Than Our Sin', author:'Julia H. Johnston (1911)', category:'Grace & Salvation', key:'F',
    verses:[
  ...
  { id:'there-is-a-fountain', title:'There Is a Fountain', author:'William Cowper (1772)', category:'Grace & Salvation', key:'D',
    verses:[
  ...
  // PRAISE & WORSHIP
  { id:'holy', title:'Holy, Holy, Holy', author:'Reginald Heber (1826)', category:'Praise & Worship', key:'D',
    verses:[
  ...
  { id:'all-hail', title:"All Hail the Power of Jesus' Name", author:'Edward Perronet (1779)', category:'Praise & Worship', key:'Bb',
    verses:[
  ...
  { id:'to-god-be-glory', title:'To God Be the Glory', author:'Fanny J. Crosby (1875)', category:'Praise & Worship', key:'Bb',
    verses:[
  ...
  { id:'crown-him', title:'Crown Him with Many Crowns', author:'Matthew Bridges (1851)', category:'Praise & Worship', key:'Eb',
    verses:[
  ...
  { id:'praise-him', title:'Praise Him! Praise Him!', author:'Fanny J. Crosby (1869)', category:'Praise & Worship', key:'G',
    verses:[
  ...
  // FAITH & TRUST
  { id:'great-is-thy', title:'Great Is Thy Faithfulness', author:'Thomas O. Chisholm (1923)', category:'Faith & Trust', key:'Bb',
    verses:[
  ...
  { id:'blessed-assurance', title:'Blessed Assurance', author:'Fanny J. Crosby (1873)', category:'Faith & Trust', key:'D',
    verses:[
  ...
  { id:'tis-so-sweet', title:"'Tis So Sweet to Trust in Jesus", author:'Louisa M. R. Stead (1882)', category:'Faith & Trust', key:'F',
    verses:[
  ...
  { id:'leaning', title:'Leaning on the Everlasting Arms', author:'Elisha A. Hoffman (1887)', category:'Faith & Trust', key:'G',
    verses:[
  ...
  { id:'standing-on-promises', title:'Standing on the Promises', author:'R. Kelso Carter (1886)', category:'Faith & Trust', key:'Bb',
    verses:[
  ...
  // COMFORT & PEACE
  { id:'abide', title:'Abide With Me', author:'Henry Francis Lyte (1847)', category:'Comfort & Peace', key:'Eb',
    verses:[
  ...
  { id:'it-is-well', title:'It Is Well with My Soul', author:'Horatio G. Spafford (1873)', category:'Comfort & Peace', key:'Bb',
    verses:[
  ...
  { id:'what-friend', title:'What a Friend We Have in Jesus', author:'Joseph M. Scriven (1855)', category:'Comfort & Peace', key:'F',
    verses:[
  ...
  { id:'like-a-river', title:'Like a River Glorious', author:'Frances R. Havergal (1876)', category:'Comfort & Peace', key:'G',
    verses:[
  ...
  // JESUS CHRIST
  { id:'the-old-rugged-cross', title:'The Old Rugged Cross', author:'George Bennard (1913)', category:'Jesus Christ', key:'Ab',
    verses:[
  ...
  { id:'jesus-lover', title:'Jesus, Lover of My Soul', author:'Charles Wesley (1740)', category:'Jesus Christ', key:'Ab',
    verses:[
  ...
  { id:'fairest-lord', title:'Fairest Lord Jesus', author:'Münster Gesangbuch (1677)', category:'Jesus Christ', key:'Eb',
    verses:[
  ...
  { id:'take-the-name', title:'Take the Name of Jesus with You', author:'Lydia Baxter (1870)', category:'Jesus Christ', key:'G',
    verses:[
  ...
  // CONSECRATION
  { id:'have-thine', title:'Have Thine Own Way, Lord', author:'Adelaide A. Pollard (1907)', category:'Consecration', key:'G',
    verses:[
  ...
  { id:'i-surrender-all', title:'I Surrender All', author:'J. W. Van DeVenter (1896)', category:'Consecration', key:'F',
    verses:[
  ...
  { id:'take-my-life', title:'Take My Life and Let It Be', author:'Frances R. Havergal (1874)', category:'Consecration', key:'D',
    verses:[
  ...
  // SERVICE & MISSION
  { id:'onward-christian', title:'Onward, Christian Soldiers', author:'Sabine Baring-Gould (1865)', category:'Service & Mission', key:'Eb',
    verses:[
      ...
      {label:'Verse 3', text:"Onward then, ye people,\nJoin our happy throng,\nBlend with ours your voices\nIn the triumph song;\nGlory, laud, and honor\nUnto Christ the King,\nThis through countless ages\nMen and angels sing."},
    ]},
  { id:'rescue-perishing', title:'Rescue the Perishing', author:'Fanny J. Crosby (1869)', category:'Service & Mission', key:'Bb',
    verses:[
  ...
  // HEAVEN & ETERNITY
  { id:'when-the-roll', title:'When the Roll Is Called Up Yonder', author:'James M. Black (1893)', category:'Heaven & Eternity', key:'Bb',
    verses:[
  ...
  { id:'ill-fly-away', title:"I'll Fly Away", author:'Albert E. Brumley (1929)', category:'Heaven & Eternity', key:'G',
    verses:[
  ...
  { id:'sweet-by-and-by', title:'In the Sweet By and By', author:'Sanford F. Bennett (1868)', category:'Heaven & Eternity', key:'G',
    verses:[
  ...
  // CHRISTMAS
  { id:'joy-to-the-world', title:'Joy to the World', author:'Isaac Watts (1719)', category:'Christmas', key:'D',
    verses:[
  ...
  { id:'silent-night', title:'Silent Night', author:'Joseph Mohr (1818)', category:'Christmas', key:'Bb',
    verses:[
  ...
  { id:'o-little-town', title:'O Little Town of Bethlehem', author:'Phillips Brooks (1868)', category:'Christmas', key:'F',
    verses:[
...
function SidePanel({type, favorites, notes, onClose, onRemoveFav, onDeleteNote, onCopy}) {
  ...
  return (
    <div style={sp.wrap} onClick={e=>e.stopPropagation()}>
      ...
      <div style={sp.body}>
        {isEmpty
          ? <p style={sp.empty}>{isFav ? 'No favorites yet.\nTap any verse → ⭐ to save it.' : 'No notes yet.\nTap any verse → 📝 to write a note.'}</p>
          : isFav
            ? favorites.map(f=>(
...
export default function BibleReaderPage() {
  ...
  const [hymnSort, setHymnSort]         = useState('title')
  ...
  const filteredHymns = useMemo(()=>{
    ...
    if(hymnSearch.trim()){
      ...
      list=list.filter(h=>h.title.toLowerCase().includes(q)||h.author.toLowerCase().includes(q)||h.verses.some(v=>v.text.toLowerCase().includes(q)))
    }
    return [...list].sort((a,b)=>hymnSort==='author'?a.author.localeCompare(b.author):a.title.localeCompare(b.title))
    ...
    return (
      <div style={s.page}>
        ...
        <header style={s.topBar}>
          ...
          <button style={s.listenBtn} onClick={()=>isReading?stopNarration():speak(full)}>
  ...
  if (view==='hymns') {
    return (
      <div style={s.page}>
        <style>{FONT+ANIM}</style>
        <div style={s.hymnLibHead}>
          <button style={s.backBtn} onClick={()=>setView('books')}>← Back to Bible</button>
          <h1 style={s.navTitle}>🎵 Hymn Library</h1>
          <p style={s.hymnSub}>{HYMNS.length} classic hymns • Select a song to sing together</p>
          <div style={s.searchWrap}>
            <span style={s.searchIcon}>🔍</span>
            <input style={s.searchInput} type="text" placeholder="Search hymns, authors, or lyrics…"
          ...
          <div style={s.catRow}>
            {ALL_CATEGORIES.map(c=>(
              <button key={c} style={{...s.catPill,...(hymnCategory===c?s.catPillOn:{})}} onClick={()=>setHymnCategory(c)}>{c}</button>
            ))}
          </div>
          <div style={s.ctrlRow}>
            <span style={s.resultCount}>{filteredHymns.length} hymn{filteredHymns.length!==1?'s':''}</span>
            <div style={{display:'flex',alignItems:'center',gap:'6px'}}>
              <span style={{color:'#c8a96e',fontSize:'0.9rem'}}>Sort:</span>
              <button style={{...s.sortBtn,...(hymnSort==='title'?s.sortBtnOn:{})}} onClick={()=>setHymnSort('title')}>A–Z</button>
              <button style={{...s.sortBtn,...(hymnSort==='author'?s.sortBtnOn:{})}} onClick={()=>setHymnSort('author')}>Author</button>
            </div>
          </div>
        </div>
        {filteredHymns.length===0
          ? <div style={s.hymnEmpty}>
              ...
              <br/>
              <button style={{...s.backBtn,marginTop:'1rem'}} onClick={()=>{setHymnSearch('');setHymnCategory('All')}}>Clear filters</button>
            </div>
          : <div style={s.hymnGrid}>
              {filteredHymns.map(h=>(
                <button key={h.id} style={s.hymnCard} onClick={()=>{setSelectedHymn(h);setView('hymn-detail')}}>
                ...
                <div key={v.verse} style={{position:'relative'}}>
                  ...
                  {menuOpen&&(
                    <div style={s.vMenu} onClick={e=>e.stopPropagation()}>
                      <button style={s.mBtn} onClick={()=>{speak(v.text,v.verse);setActiveMenu(null)}}>
                        🔊 Listen to verse
                      </button>
                      <button style={s.mBtn} onClick={()=>copyVerse(v.text,v.verse)}>
                        📋 Copy verse
                      </button>
                      <button style={s.mBtn} onClick={()=>toggleFav(v)}>
                        {fav?'💛 Remove favorite':'⭐ Add to favorites'}
                      </button>
                      <button style={s.mBtn} onClick={()=>openNote(v.verse)}>
                        {note?'📝 Edit note':'📝 Add note'}
                      </button>
                      <button style={s.mBtn}
                        onClick={e=>{e.stopPropagation();setShareMenu(shareOpen?null:v.verse)}}>
                        📤 Share verse ▸
                      </button>
                      ...
                      <div style={s.colorRow}>
                        ...
                        {hlColor&&(
                          <button
                            style={{...s.colorDot,background:'transparent',border:'1px solid #666',color:'#aaa',fontSize:'0.7rem'}}
...
const s = {
  ...
  searchWrap:      { position:'relative', maxWidth:'500px', margin:'0 auto 1.5rem',
  ...
  ctrlRow:         { display:'flex', justifyContent:'space-between', alignItems:'center',
                     maxWidth:'900px', margin:'0 auto 1.25rem', flexWrap:'wrap', gap:'0.5rem' },
